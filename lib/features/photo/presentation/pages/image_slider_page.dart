...
class _ImageSliderPageState extends State<ImageSliderPage> {
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: AppTheme.dark,
      child: BlocListener<FavoriteImageCubit, FavoriteImageState>(
        listener: (context, state) {
          if (state is FavoriteImageError) {
            return showErrorSnackBar(context, state.message);
          }

          if (state is FavoriteImageSuccess) {
        ...
        child: BlocListener<DeleteImageCubit, DeleteImageCubitState>(
          listener: (context, state) {
            ...
            if (state is DeleteImageCubitSuccess) {
              ...
              final deletedIndex = images.indexWhere((image) =>
                  image.imageBucketId == imageBucketId &&
              ...
              if (deletedIndex != -1) {
                ...
                if (deletedIndex == _currentIndex) {
                  newIndex = _currentIndex < images.length - 1
                      ? _currentIndex
                      : _currentIndex - 1;
          ...
          child: BlocListener<EditCaptionBloc, EditCaptionState>(
            listener: (context, state) {
              ...
              if (state is EditCaptionSuccess) {
                ...
                final index =
                    images.indexWhere((element) => element.id == imageId);
                      ...
                      actions: [
                        IconButton(
                          ...
                          onPressed: () {
                            ...
                            final albumState =
                                context.read<AlbumListBloc>().state;
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      textIcon(
                                          images[_currentIndex].isFavorite
