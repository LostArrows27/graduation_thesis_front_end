                                                                  ...
                                                                  .builder(
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        return GestureDetector(
                                                                          onTap:
                                                                              () {
                                                                            chooseAlbumImageModel.setProvidedImage(newAlbumList[index].imageList);
                                                                            context.read<ChooseImageModeCubit>().changeViewMode(ChooseImageMode.all);
                                                                          },
                                                                          child:
                                                                              Column(
                                                                            mainAxisAlignment:
                                                                            ...
                                                                            crossAxisAlignment:
                                                                                CrossAxisAlignment.start,
                                                                            children: [
                                                                              SizedBox(height: 180, width: double.infinity, child: CachedImage(borderRadius: 20, imageUrl: album.imageList[0].imageUrl!)),
                                                                              SizedBox(height: 10),
                                                                              Text(maxLines: 1, overflow: TextOverflow.ellipsis, album.name, style: TextStyle(fontSize: 12, color: Theme.of(context).colorScheme.outline))
                                                                            ],
                                                                          ),
                                                                        );
                                                                      }),
